export default function Paginacao({children,dados}) {
    ...
    function montarPaginas() {
        ...
        if(divPaginacao !== null) {      
            ...
            divPaginasDados+= `<a class='page-link'href='/peso/0'>Primeiro</a></li>`;

             for(var i=1; i<dados.paginacao.totalPages+1; i++){
                divPaginasDados+= `<li class="page-item"><a class="page-link" href="/peso/${i-1}">${i}</a></li>`;
             }             

             divPaginasDados+= "<li class='page-item'>";
             divPaginasDados+= `<a class='page-link' href='/peso/${i-2}'>Último</a></li>`;
             divPaginasDados+= "</ul>";
             divPaginasDados+= "</nav>";
             divPaginasDados+= "</div>";
